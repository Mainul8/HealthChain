...
export const PatientForm = ({ orgContract, web3, onSuccess = null,user }) => {
    ...
    const handleOnSubmit = async (e) => {
        ...
        function generatePatientId(){
            ...
            const id=formData.email.value+formData.patient_name.value;
            return id;
                        ...
                        <div className="row g-3 mb-5">
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    className={`form-control ${
                                        formData.patient_name.error ? "is-invalid" : ""
                                    }`}
                                />
                            ...
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    className={`form-control ${
                                        formData.mobno.error ? "is-invalid" : ""
                                    }`}
                                />
                            ...
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    className={`form-control ${
                                        formData.report_date.error ? "is-invalid" : ""
                                    }`}
                                />
